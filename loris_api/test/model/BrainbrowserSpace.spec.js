...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LorisApi.BrainbrowserSpace();
  });
  ...
  describe('BrainbrowserSpace', function() {
    it('should create an instance of BrainbrowserSpace', function() {
      // uncomment below and update the code to test BrainbrowserSpace
      //var instane = new LorisApi.BrainbrowserSpace();
      //expect(instance).to.be.a(LorisApi.BrainbrowserSpace);
    });
