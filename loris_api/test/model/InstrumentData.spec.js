...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LorisApi.InstrumentData();
  });
  ...
  describe('InstrumentData', function() {
    it('should create an instance of InstrumentData', function() {
      // uncomment below and update the code to test InstrumentData
      //var instane = new LorisApi.InstrumentData();
      //expect(instance).to.be.a(LorisApi.InstrumentData);
    });
